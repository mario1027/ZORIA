...
external_stylesheets = [
    ...
    "https://cdn.jsdelivr.net/gh/stevej2608/volt-bootstrap-5-dashboard@1.4.2/dist/css/volt.min.css",
    ]
...
def create_app(dash_factory) -> DashSPA:
    ...
    # Importar y registrar páginas después de crear la app
    from pages.simulator_page import register_simulator_page
...
if __name__ == "__main__":
    ...
    sport = int(os.environ.get("PORT", 5001))
    hostname = os.environ.get("HOSTNAME", "localhost")
    hostport = os.environ.get("HOSTPORT", str(sport))

    print(f' * Visit http://{hostname}:{hostport}{"/"}')
    server.run(host='0.0.0.0', port=sport, debug=True)
