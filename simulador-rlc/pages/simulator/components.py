...
from ..icons.components import get_component_icon_element
...
def circuit_selector_card():
    ...
    return html.Div([
        html.Div([
            ...
            html.Div([
                html.Label("Tipo de Circuito", className='form-label fw-bold', htmlFor='circuit-type'),
                dcc.Dropdown(
                    id='circuit-type',
                    options=[
                        # ============ CIRCUITOS IDEALES ============
...
def resistance_input_card():
    ...
    return html.Div([
        html.Div([
            html.Label([
                get_component_icon_element('R', className='me-2', style={'width': '20px', 'height': '20px', 'filter': 'hue-rotate(340deg) saturate(2)'}),
                "Resistencia (R)"
            ...
            html.Div([
                ...
                html.Span("Ω", className='input-group-text')
                        ...
                        html.Small("Ejemplo: 1000 = 1 kΩ | Rango: 1 Ω - 10 MΩ", className='form-text text-muted')
        ], className='card-body')
...
def inductance_input_card():
    ...
    return html.Div([
        html.Div([
            html.Label([
                get_component_icon_element('L', className='me-2', style={'width': '20px', 'height': '20px', 'filter': 'hue-rotate(220deg) saturate(2)'}),
                "Inductancia (L)"
            ...
            html.Small("Ejemplo: 0.001 = 1 mH | Rango: 1 nH - 100 H", className='form-text text-muted')
        ], className='card-body')
...
def capacitance_input_card():
    ...
    return html.Div([
        html.Div([
            html.Label([
                get_component_icon_element('C', className='me-2', style={'width': '20px', 'height': '20px', 'filter': 'hue-rotate(120deg) saturate(2)'}),
                "Capacitancia (C)"
            ...
            html.Small("Ejemplo: 0.000001 = 1 µF | Rango: 1 pF - 1 F", className='form-text text-muted')
        ], className='card-body')
...
def frequency_range_card():
    ...
    return html.Div([
        html.Div([
            ...
            # Frecuencia inicial
            html.Div([
                html.Label("Frecuencia Inicial", className='form-label fw-bold', htmlFor='freq-start'),
                html.Div([
                    html.Span([
            ...
            # Frecuencia final
            html.Div([
                html.Label("Frecuencia Final", className='form-label fw-bold', htmlFor='freq-end'),
                html.Div([
                    html.Span([
            ...
            # Número de puntos
            html.Div([
                html.Label("Número de Puntos", className='form-label fw-bold', htmlFor='freq-points'),
                html.Div([
                    html.Span([
...
def nyquist_plot_card():
    ...
    return html.Div([
        html.Div([
            html.H5([
                html.Span(ICON.CHART, className='me-2'),
...
def impedance_info_card():
    ...
    return html.Div([
        html.Div([
            html.H5([
                html.Span(ICON.CLIPBOARD, className='me-2'),
                "Información de Impedancia"
            ], className='card-title mb-0')
        ], className='card-header bg-soft border-bottom'),
        html.Div([
            html.Div(id='impedance-info', className='text-center py-4')
        ], className='card-body')
