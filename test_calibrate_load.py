#!/usr/bin/env python3
"""
Script para ejecutar SOLO calibrate load
Asume que ya está conectada la carga de 1001Ω
"""
...
def main():
    ...
    try:
        ...
        print("="*70)
        print("Ejecutando: calibrate load")
        print("="*70)
        print()
        
        # Enviar calibrate load (puede tardar varios segundos)
        response = send_command(ser, "calibrate load", timeout=30.0)
